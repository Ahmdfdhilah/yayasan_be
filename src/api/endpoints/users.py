...
@router.put("/me/profile/{field_name}", response_model=UserResponse, summary="Update specific profile field")
...
@router.get("", response_model=UserListResponse, dependencies=[Depends(admin_or_manager)], summary="List all users")
...
@router.post("", response_model=UserResponse, dependencies=[Depends(admin_required)], summary="Create new user")
async def create_user(
    user_data: UserCreate,
    organization_id: Optional[int] = Query(None, description="Organization ID for the user"),
    user_service: UserService = Depends(get_user_service)
):
    """
    Create a new user.
...
@router.get("/{user_id}", response_model=UserResponse, dependencies=[Depends(admin_or_manager)], summary="Get user by ID")
async def get_user(
    user_id: int,
    user_service: UserService = Depends(get_user_service)
):
...
@router.put("/{user_id}", response_model=UserResponse, dependencies=[Depends(admin_required)], summary="Update user")
...
@router.delete("/{user_id}", response_model=MessageResponse, dependencies=[Depends(admin_required)], summary="Delete user")
...
@router.post("/{user_id}/reset-password", response_model=MessageResponse, dependencies=[Depends(admin_required)], summary="Reset user password")
...
@router.post("/{user_id}/activate", response_model=UserResponse, dependencies=[Depends(admin_required)], summary="Activate user")
...
@router.post("/{user_id}/deactivate", response_model=UserResponse, dependencies=[Depends(admin_required)], summary="Deactivate user")
...
@router.post("/{user_id}/suspend", response_model=UserResponse, dependencies=[Depends(admin_required)], summary="Suspend user")
...
@router.put("/{user_id}/profile", response_model=UserResponse, dependencies=[Depends(admin_required)], summary="Update user profile")
...
@router.get("/{user_id}/profile/{field_name}", dependencies=[Depends(admin_or_manager)], summary="Get user profile field")
...
@router.put("/{user_id}/profile/{field_name}", response_model=UserResponse, dependencies=[Depends(admin_required)], summary="Update user profile field")
...
@router.get("/statistics/overview", dependencies=[Depends(admin_or_manager)], summary="Get user statistics")
...
@router.get("/by-role/{role_name}", response_model=list[UserResponse], dependencies=[Depends(admin_or_manager)], summary="Get users by role")
...
@router.get("/search/by-email", response_model=UserResponse, dependencies=[Depends(admin_or_manager)], summary="Find user by email")
