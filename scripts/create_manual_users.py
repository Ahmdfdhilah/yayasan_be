...
class ManualUserCreator:
    ...
    async def get_organization_id(self, org_name: str) -> int:
        ...
        query = text("SELECT id FROM organizations WHERE name = :name AND deleted_at IS NULL")
    ...
    async def create_user_direct(self, email: str, password: str, profile: dict, organization_name: str = None) -> int:
    ...
    async def create_user_role_direct(self, user_id: int, role_name: str, organization_id: int = None) -> int:
    ...
    async def create_all_users(self):
        ...
        users_data = [
            {
                ...
                "profile": {"name": "Super Administrator", "phone": "081234567890"},
                "organization": None,
                "roles": ["super_admin"]
            },
            {
            ...
            },
            {
                ...
                "password": "@KepSek123",
                "profile": {"name": "Dr. Ahmad Susanto, M.Pd", "position": "Kepala Sekolah"},
            ...
            },
            {
                ...
                "password": "@Guru123",
                "profile": {"name": "Budi Santoso, S.Pd", "subject": "Bahasa Indonesia"},
                "organization": "SMA Negeri 1 Jakarta",
                "roles": ["guru"]
            },
            {
                ...
                "password": "@KepSek123",
                "profile": {"name": "Dra. Sri Mulyani, M.M", "position": "Kepala Sekolah"},
            ...
            },
            {
                ...
                "password": "@Content123",
                "profile": {"name": "Maya Sari, S.Kom", "position": "Content Manager"},
        ...
        for user_data in users_data:
            ...
            result = await self.session.execute(check_query, {"email": user_data["email"]})
            if result.scalar():
            ...
            if user_id:
                ...
                if user_data["organization"]:
                    try:
                        org_id = await self.get_organization_id(user_data["organization"])
                    except:
                        org_id = None
